        ...
        <div data-aos="fade-zoom-in" data-aos-duration="800" data-aos-delay="400">
            <div className="container mx-auto px-5 flex justify-center">
                <div className="py-10 max-w-7xl ">
                    <h1 className="font-bold tracking-[2px] text-3xl mb-8">Confirm your Booking</h1>
                    <form ref={form} onSubmit={sendEmail} className="grid lg:grid-cols-2 gap-20">
                        ...
                        <div data-aos="flip-left"
                            data-aos-easing="ease-out-cubic" className="col-span-1">
                            <img className="w-full" src={contactImg} alt="ContactImage" />
                        </div>
                    </form>
                </div>
            </div>
